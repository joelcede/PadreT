    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('procedure', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='client_data', to='procedure.generalprocedure')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_data', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='municipal_account', to='clientData.clientdata')),
            ],
        ),
        migrations.CreateModel(
            name='HousesClient',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('home_client', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='house_cadastral', to='clientData.housesclient')),
            ],
        ),
    ]
